...
public class Event01DAOjdbc implements Event01DAO {
	...
	public List<Event01> selectthisweek() {
		Query<Event01> query =this.getSession().createQuery("FROM Event01 where  datediff( day , getdate() , DurationEnd ) >= 0 order by datediff ( day , getdate() , DurationEnd )", Event01.class);
	...
	public List<Event01> selectthisweek(String types) {
		Query<Event01> query =this.getSession().createQuery("FROM Event01 where  EventTypeID = :types and datediff( day , getdate() , DurationEnd ) >= 0 order by datediff ( day , getdate() , DurationEnd )", Event01.class);
	...
	public List<Event01> selectcollectionCount() {
		Query<Event01> query =this.getSession().createQuery("FROM Event01 where datediff( day , getdate() , DurationEnd ) >= 0 order by collectionCount", Event01.class);
		query.setMaxResults(5);
		return query.getResultList();
	}
	...
	public List<Event01> selectcollectionCount(String types) {
		Query<Event01> query =this.getSession().createQuery("FROM Event01 where EventTypeID = :types and datediff( day , getdate() , DurationEnd ) >= 0 order by collectionCount", Event01.class);
		query.setParameter("types", types);
		query.setMaxResults(5);
		return query.getResultList();
	}
	...
	public List<Event01> selectshareCount(String types) {
		Query<Event01> query =this.getSession().createQuery("FROM Event01 where EventTypeID = :types and datediff( day , getdate() , DurationEnd ) >= 0 order by shareCount", Event01.class);
		query.setParameter("types", types);
		query.setMaxResults(5);
		return query.getResultList();
	}
