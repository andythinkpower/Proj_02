    ...
    <nav class="navbar navbar-expand-sm navbar-light p-4" style="background-color:	#EBD6D6;">
        <div class="container">
            <a href="" class="navbar-brand">
                <img src="taipei-logo.jpg" width="30" height="30" class="d-inline-block align-top" />
                TaipeiTalk
            </a>
                ...
                <ul class="navbar-nav ml-auto">
                    ...
                    <li class="nav-item dropdown mr-3">
                        ...
                        <div class="dropdown-menu">
                            ...
                            <a href="" class="dropdown-item">行程安排</a>
                            <a href="" class="dropdown-item">活動收藏</a>
                            <a href="" class="dropdown-item">部落格</a>
                        </div>
                    </li><!--會員下拉式選單end here-->
                    <li class="nav-item dropdown mr-3">
                        <a href="" class="nav-link drop-toggle" data-toggle="dropdown">
                            <img src="default.jpg" width="30" height="30" class="d-inline-block align-top" /></a>
                        <div class="dropdown-menu">
